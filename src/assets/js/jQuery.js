$(function () {
  ...
  function typed() {
    let pereloaderTypedText = $(".preloader");

    if (pereloaderTypedText.length > 0) {
    ...
    if (starter.length > 0) {
      ...
      function insertNode(elem) {
        ...
        if (!Number.isInteger(currentIndex / nodesInRow)) {
          ...
          const newBeforeIndex =
            Math.floor(currentIndex / nodesInRow) * nodesInRow;
  ...
  function checkboxDisabled() {
    let checkbox = $(
      "#edit-field-my-kategorie .input-group__checkbox input:checkbox"
    );
    let checkboxWrap = $(
      "#edit-field-my-kategorie .input-group__clarification"
    );
    $(this).on("click", function () {
      const myCount = $(
        "#edit-field-my-kategorie .input-group__checkbox input:checkbox:checked"
      ).length;
